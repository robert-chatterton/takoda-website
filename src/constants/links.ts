export const youtube = 'https://www.youtube.com/@TakodaDionne';
export const youtubeHandle = '@TakodaDionne';
export const youtubeEmbedLink =
  'https://www.youtube.com/embed/Qm5q4mcrW8o?si=rYNIB-PfspxSINcs';
